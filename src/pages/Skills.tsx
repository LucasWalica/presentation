...
function SectionTitle({ text }: { text: string }) {
  return <h2 className="text-2xl md:text-4xl font-bold underline neon-glow pt-12">{text}</h2>;
}
...
export default function SkillPage() {
  return (
    <div className="min-h-screen bg-custom-background orbitron text-custom-neonGreen">
      <NavBar />
      <main className="w-11/12 mx-auto flex flex-col items-center space-y-12 mt-20 pb-20">
